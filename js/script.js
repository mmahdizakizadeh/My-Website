...
:root {
  --my-name-color: #171717d9;
  --my-name-color-hover: #171717f2;
  --background: #f3f1ec;
  --surface: #e8e5de;
  --text: #171717;
  --text-active: #a0895f;
  --text-shadow-active: #574f3f;
  --muted: #77736c;
  --border: #d5d1c8;
  --border-email: #757575;
  --dark: #171717;
  --dark-text: #ffffff;
  --accent: #9a5b45;
  --header-start: rgba(243, 241, 236, 1);
  --header-middle: rgba(243, 241, 236, 0.65);
  --header-end: rgba(243, 241, 236, 0);
  --contact-background: #d6d1c7;
  --project-background: #dedbd3;
  --project-line: #77736b;
  --project-dark: #222222;
  --timeline-border: #3c3c3c;
  --timeline-muted: #85817a;
  --timeline-text: #aaa69e;
...
body.dark-mode {
  ...
  --border: #383838;
  --dark: #090909;
  --my-name-color: rgba(242, 240, 235, 0.9);
  --my-name-color-hover: rgba(242, 240, 235, 0.95);
  --header-start: rgba(21, 21, 21, 1);
  --header-middle: rgba(21, 21, 21, 0.65);
  --header-end: rgba(21, 21, 21, 0);
  --contact-background: #242321;
  --project-background: #292929;
  --project-line: #66635d;
  --project-dark: #111111;
}
...
.my-name .first-name > em,
.my-name .last-name > em {
  display: inline-block;
  cursor: pointer;
  font-family: inherit;
...
.hero-circle span:active {
  color: var(--text-active);
  transform: scale(1.17) skew(-15deg);
}
...
.email {
  ...
  padding: 24px 0;
  background: transparent;
  border-top: 1px solid var(--border-email);
...
.email:active {
  color: var(--text-active);
  text-shadow: 2px 2px 2px 10px var(--text-shadow-active);
